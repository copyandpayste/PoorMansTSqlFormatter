//------------------------------------------------------------------------------
// <copyright file="TSqlSettingsCommandPackage.cs" company="Company">
...
namespace PoorMansTSqlFormatterExtension
{
    ...
    public sealed class TSqlSettingsCommandPackage : Package
    {
        /// <summary>
        /// TSqlSettingsCommandPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "9079affb-84f8-4164-b5db-6a5cd9ffe3ba";

        /// <summary>
        /// Initializes a new instance of the <see cref="TSqlSettingsCommand"/> class.
        /// </summary>
        public TSqlSettingsCommandPackage()
        {
